...
def dealer_hit():
	...
	if dealer_area < 3:
		...
		if dealer_area == 0:
				dealer_image1 = size_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
				dealer_label_1.config(image=dealer_image1)
				dealer_area += 1
		elif dealer_area == 1:
			dealer_image2 = size_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
			dealer_label_2.config(image=dealer_image2)
			dealer_area += 1
		elif dealer_area == 2:
			dealer_image3 = size_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
...
def player_hit():
	...
	if player_area < 3:
		...
		if player_area == 0:
			player_image1 = size_cards(f'C:/project-pscp/Bac-ra-cat/{player_card}.png')
			player_label_1.config(image=player_image1)
			player_area += 1
		elif player_area == 1:
			player_image2 = size_cards(f'C:/project-pscp/Bac-ra-cat/{player_card}.png')
			player_label_2.config(image=player_image2)
			player_area += 1
		elif player_area == 2:
			player_image3 = size_cards(f'image/Bac-ra-cat/{player_card}.png')
...
stand_button = Button(button_frame, text="Play!", font=("Helvetica", 14), command=play)
stand_button.grid(row=0, column=2)

selec_player_button = Button(button_frame, text="Player", font=("Helvetica", 14), command=selec_player)
selec_player_button.grid(row=1, column=0)

selec_player_button = Button(button_frame, text="Tie", font=("Helvetica", 14), command=selec_tie)
selec_player_button.grid(row=1, column=1)


selec_player_button = Button(button_frame, text="Dealer", font=("Helvetica", 14), command=selec_dealer)
selec_player_button.grid(row=1, column=2)
