...
def dealer_hit():
	...
	if dealer_spot < 3:
		try:
			...
			if dealer_spot == 0:
				# Resize Card
				dealer_image1 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
				...
				# Resize Card
				dealer_image2 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image3 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{dealer_card}.png')
				# Output Card To Screen
...
def player_hit():
	global player_spot, player_total
	for score in player_score:
		player_total += score
	if player_spot < 3:
		try:
			...
			if player_spot == 0:
				# Resize Card
				player_image1 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image2 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image3 = resize_cards(f'C:/project-pscp/Bac-ra-cat/{player_card}.png')
				# Output Card To Screen
...
def deal_cards():
	try:
		...
		# Output Card To Screen
		global dealer_image
		dealer_image = resize_cards(f'C:/project-pscp/Bac-ra-cat/{card}.png')
		dealer_image.config(image=dealer_image)
		#dealer_label.config(text=card)

		# Get the player Card
		card = random.choice(deck)
		player.append(card)
		# Output Card To ScreenC:\project-pscp\Bac-ra-cat
		global player_image
		player_image = resize_cards(f'C:/project-pscp/Bac-ra-cat/{card}.png')
		player_image.config(image=player_image)
